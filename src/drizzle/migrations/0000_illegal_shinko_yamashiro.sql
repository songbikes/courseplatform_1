...
CREATE TYPE "public"."lesson_section_status" AS ENUM('public', 'private', 'preview');--> statement-breakpoint
...
CREATE TABLE "lessons" (
	...
	"order" integer NOT NULL,
	"status" "lesson_section_status" DEFAULT 'private' NOT NULL,
...
ALTER TABLE "purchases" ADD CONSTRAINT "purchases_userId_users_id_fk" FOREIGN KEY ("userId") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
